This profile is based on and further constrains the [US Public Health Encounter]({{site.data.fhir.ver.hl7fhirusphlibrary}}/StructureDefinition-us-ph-encounter.html) profile.

A trigger on an encounter diagnosis is indicated by the [eICR Trigger Code Flag Extension](StructureDefinition-eicr-trigger-code-flag-extension.html) in the diagnosis.
