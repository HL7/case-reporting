...
* relatedArtifact[sliceUSPHValueSet] ^short = "US Public Health Supplemental Value Set"
* relatedArtifact[sliceUSPHValueSet] ^definition = "Reference to one of the US Public Health Supplemental value sets"
...
* relatedArtifact[sliceUSPHValueSet].resource only Canonical(USPublicHealthSupplementalValueSet)