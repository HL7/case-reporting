...
* section[sliceChiefComplaintSection] ^isModifier = false
...
* section[sliceChiefComplaintSection].code ^isModifier = false
...
* section[sliceHistoryOfPresentIllnessSection] ^isModifier = false
...
* section[sliceHistoryOfPresentIllnessSection].code ^isModifier = false
...
* section[sliceProblemSection].entry[sliceEICRCondition] ^isModifier = false
...
* section[sliceAdmissionMedicationsSection].entry[sliceMedication] ^isModifier = false
...
* section[sliceResultsSection].entry[sliceUSPHLabResultObservation] ^isModifier = false
...
* section[slicePlanOfTreatmentSection].entry[sliceEICRServiceRequest] ^isModifier = false
...
* section[slicePlanOfTreatmentSection].entry[sliceUSCoreMedicationRequest] ^isModifier = false
...
* section[sliceImmunizationsSection].entry[sliceUSCoreImmunization] ^isModifier = false
...
* section[sliceVitalSignsSection].entry[sliceVitalSigns] ^isModifier = false
...
* section[sliceSocialHistorySection].entry[sliceTravelHistory] ^isModifier = false
...
* section[sliceEmergencyOutbreakInformationSection] ^isModifier = false
...
* section[sliceEmergencyOutbreakInformationSection].code ^isModifier = false
...
* section[slicePastMedicalHistorySection] ^isModifier = false
...
* section[slicePastMedicalHistorySection].code ^isModifier = false
...
* section[slicePastMedicalHistorySection].entry[sliceUSCoreCondition] ^isModifier = false
...
* section[sliceReviewOfSystemsSection] ^isModifier = false
...
* section[sliceReviewOfSystemsSection].code ^isModifier = false
...
* section[sliceReportabilityResponseInformationSection] ^isModifier = false
...
* section[sliceReportabilityResponseInformationSection].code ^isModifier = false
