...
Title: "US PH Encounter Example: encounter-eicr-eve-everywoman-current-inpatient"
Description: "Example of US Public Health Encounter profile (Eve Everywoman: current inpatient)"
Usage: #example
