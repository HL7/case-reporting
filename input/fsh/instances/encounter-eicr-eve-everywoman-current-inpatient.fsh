Instance: encounter-eicr-eve-everywoman-current-inpatient
InstanceOf: EICREncounter
Title: "Encounter - Current Inpatient Visit for Eve Everywoman"
Description: "Example of an eICR Encounter representing an in-progress inpatient encounter for patient Eve Everywoman with Zika virus disease diagnosis."
Usage: #example
