Instance: 2.16.840.1.113762.1.4.1146.1602
...
* compose.include.concept[0].code = #2043317
* compose.include.concept[=].display = "1.33 ML ibalizumab-uiyk 150 MG/ML Injection"
* compose.include.concept[+].code = #2043322
* compose.include.concept[=].display = "1.33 ML ibalizumab-uiyk 150 MG/ML Injection [Trogarzo]"
