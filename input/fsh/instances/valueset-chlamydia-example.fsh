Instance: valueset-chlamydia-example
...
* version = "1.0.0"
* name = "Example_Chlamydia_Lab_Obs_Test_Name_Triggers_for_Public_Health_Reporting"
...
* useContext[focusConditionContext].code = $usage-context-type#focus "Clinical Focus"
* useContext[focusConditionContext].valueCodeableConcept = $sct#240589008 "Chlamydia trachomatis infection"
