...
Description: "Example of a US Public Health Reporting message bundle containing an electronic case report for a Zika virus infection case involving patient Eve Everywoman."
Usage: #example
