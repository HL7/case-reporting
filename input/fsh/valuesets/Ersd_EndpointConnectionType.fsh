ValueSet: Ersd_EndpointConnectionType
...
* ^meta.profile = "http://hl7.org/fhir/us/ecr/StructureDefinition/us-ph-executable-valueset"
* ^extension[0].url = "http://hl7.org/fhir/us/ecr/StructureDefinition/us-ph-usagewarning-extension"
...
* ^expansion.contains[0].system = "http://terminology.hl7.org/CodeSystem/endpoint-connection-type"
* ^expansion.contains[=].code = #ihe-xcpd
* ^expansion.contains[=].display = "IHE XCPD"
* ^expansion.contains[+].system = "http://terminology.hl7.org/CodeSystem/endpoint-connection-type"
...
* ^expansion.contains[+].system = "http://hl7.org/fhir/us/ecr/CodeSystem/ersd-endpoint-connection-type"
