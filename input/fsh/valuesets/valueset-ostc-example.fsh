ValueSet: ValueSetOSTCExample
Id: valueset-ostc-example
Title: "Example OSTC Triggers for Public Health Reporting"
...
* ^url = "http://example.org/fhir/us/ecr/ValueSet/valueset-ostc-example"
...
* ^compose.include[0].valueSet = $2.16.840.1.113762.1.4.1146.528-example
* ^compose.include[+].valueSet = $2.16.840.1.113762.1.4.1146.408-example
* ^compose.include[+].valueSet = $2.16.840.1.113762.1.4.1146.409-example
* ^compose.include[+].valueSet = $2.16.840.1.113762.1.4.1146.1469-example
* ^compose.include[+].valueSet = $2.16.840.1.113762.1.4.1146.1468-example
