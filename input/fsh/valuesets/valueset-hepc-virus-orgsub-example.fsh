...
* ^url = "http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113762.1.4.1146.409-example"
...
* $sct#371140008 "Polymerase chain reaction positive for hepatitis C viral ribonucleic acid genotype 1A (finding)"
...
* $sct#711331006 "Polymerase chain reaction test for Hepatitis C positive (finding)"
