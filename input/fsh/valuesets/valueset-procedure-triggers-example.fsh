ValueSet: ValueSetProcedureTriggersExample
Id: valueset-procedure-triggers-example
...
* ^url = "http://example.org/fhir/us/ecr/ValueSet/valueset-procedure-triggers-example"
