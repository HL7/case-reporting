...
* ^compose.include[0].valueSet = $2.16.840.1.113762.1.4.1146.1601-example
* ^compose.include[+].valueSet = $2.16.840.1.113762.1.4.1146.1600-example
* ^compose.include[+].valueSet = $2.16.840.1.113762.1.4.1146.1603-example
* ^compose.include[+].valueSet = $2.16.840.1.113762.1.4.1146.1602-example
* ^compose.include[+].valueSet = $2.16.840.1.113762.1.4.1146.1082-example
