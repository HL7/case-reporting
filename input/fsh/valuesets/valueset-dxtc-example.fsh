...
* ^compose.include[0].valueSet = $2.16.840.1.113762.1.4.1146.1506-example
* ^compose.include[+].valueSet = $2.16.840.1.113762.1.4.1146.1505-example
* ^compose.include[+].valueSet = $2.16.840.1.113762.1.4.1146.1508-example
* ^compose.include[+].valueSet = $2.16.840.1.113762.1.4.1146.1507-example
* ^compose.include[+].valueSet = $2.16.840.1.113762.1.4.1146.6-example
