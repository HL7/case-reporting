ValueSet: ValueSetMeaslesSuspectedExample
Id: 2.16.840.1.113762.1.4.1146.1436-example
...
* ^url = "http://example.org/fhir/us/ecr/ValueSet/2.16.840.1.113762.1.4.1146.1436-example"
...
* $sct#772152006 "Measles suspected (situation)"
