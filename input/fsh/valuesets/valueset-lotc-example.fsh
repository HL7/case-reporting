ValueSet: ValueSetLOTCExample
Id: valueset-lotc-example
Title: "Example LOTC Triggers for Public Health Reporting"
...
* ^url = "http://example.org/fhir/us/ecr/ValueSet/valueset-lotc-example"
...
* ^compose.include[0].valueSet = $2.16.840.1.113762.1.4.1146.480-example
* ^compose.include[+].valueSet = $2.16.840.1.113762.1.4.1146.481-example
* ^compose.include[+].valueSet = $2.16.840.1.113762.1.4.1146.761-example
* ^compose.include[+].valueSet = $2.16.840.1.113762.1.4.1146.1223-example
* ^compose.include[+].valueSet = $2.16.840.1.113762.1.4.1146.762-example
