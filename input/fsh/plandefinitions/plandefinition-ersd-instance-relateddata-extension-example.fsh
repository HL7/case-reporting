...
Title: "PlanDefinition - eRSD Instance with RelatedData Extension"
...
// * action[checkSuspectedDisorder].action[isEncounterSuspectedDisorder].input[=].codeFilter.valueSet = "http://example.org/fhir/us/ecr/ValueSet/valueset-suspected-disorder-triggers-example"
...
// * action[checkSuspectedDisorder].action[isEncounterSuspectedDisorder].input[=].codeFilter.valueSet = "http://example.org/fhir/us/ecr/ValueSet/valueset-lab-order-test-triggers-example"
...
// * action[checkSuspectedDisorder].action[isEncounterSuspectedDisorder].input[=].codeFilter.valueSet = "http://example.org/fhir/us/ecr/ValueSet/valueset-medications-triggers-example"
...
// * action[checkReportable].action[isEncounterReportable].input[=].codeFilter.valueSet = "http://example.org/fhir/us/ecr/ValueSet/valueset-diagnosis-problem-triggers-example"
...
// * action[checkReportable].action[isEncounterReportable].input[=].codeFilter.valueSet = "http://example.org/fhir/us/ecr/ValueSet/valueset-medications-triggers-example"
...
// * action[checkReportable].action[isEncounterReportable].input[=].codeFilter.path = "code"
// * action[checkReportable].action[isEncounterReportable].input[=].codeFilter.valueSet = "http://example.org/fhir/us/ecr/ValueSet/valueset-lab-order-test-triggers-example"
...
// * action[checkReportable].action[isEncounterReportable].input[=].type = #ServiceRequest
// * action[checkReportable].action[isEncounterReportable].input[=].codeFilter.path = "code"
// * action[checkReportable].action[isEncounterReportable].input[=].codeFilter.valueSet = "http://example.org/fhir/us/ecr/ValueSet/valueset-procedure-triggers-example"
