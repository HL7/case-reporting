...
// * action[checkForImmediateReporting].action[isEncounterImmediatelyReportable].condition.expression.extension.url = "http://hl7.org/fhir/StructureDefinition/cqf-alternativeExpression"
// * action[checkForImmediateReporting].action[isEncounterImmediatelyReportable].condition.expression.extension.valueExpression.language = #text/cql-identifier
// * action[checkForImmediateReporting].action[isEncounterImmediatelyReportable].condition.expression.extension.valueExpression.expression = "Is Suspected Disorder?"
// * action[checkForImmediateReporting].action[isEncounterImmediatelyReportable].condition.expression.extension.valueExpression.reference = "http://hl7.org/fhir/us/ecr/Library/library-executable-rule-filters-example"
...
// * action[checkForImmediateReporting].action[continueCheckReportable].condition.expression.extension.url = "http://hl7.org/fhir/StructureDefinition/cqf-alternativeExpression"
// * action[checkForImmediateReporting].action[continueCheckReportable].condition.expression.extension.valueExpression.language = #text/cql-identifier
// * action[checkForImmediateReporting].action[continueCheckReportable].condition.expression.extension.valueExpression.expression = "Is Encounter In Progress and Within Normal Reporting Duration or 72h or less after end of encounter?"
// * action[checkForImmediateReporting].action[continueCheckReportable].condition.expression.extension.valueExpression.reference = "http://hl7.org/fhir/us/ecr/Library/library-executable-rule-filters-example"
// * action[checkForImmediateReporting].action[continueCheckReportable].condition.expression.language = #text/fhirpath
// * action[checkForImmediateReporting].action[continueCheckReportable].condition.expression.expression = "%encounter.where((status = 'in-progress' and period.start + 1 day * %normalReportingDuration >= now()) or (status = 'finished' and period.end + 72 hours >= now())).select(true)"
...
* action[createEicr].input[=].profile = $USCorePatientProfile
...
* action[createEicr].input[=].profile = $USCoreConditionEncounterDiagnosisProfile
...
* action[createEicr].input[=].profile = $USCoreConditionEncounterProfile
...
* action[createEicr].input[=].profile = $USCoreMedicationRequestProfile
...
* action[createEicr].input[=].profile = $USCoreImmunizationProfile
...
* action[createEicr].input[=].profile = $USCoreProcedureProfile
...
* action[createEicr].input[=].profile = $USCoreObservationLab
...
* action[createEicr].input[=].profile = $USCoreDiagnosticReportLab
