...
#### Table: EICR Data Elements to eCR Composition Profile

|Data Element Common Name / CSTE eCR Task Force Name |Sub-Element Name|Published mappings to CDA Conformance ID|Target eCR Composition profile elements|Target FHIR Profile elements referenced through the eCR Composition profile||Referenced Profile|
|---|---|---|---|---|---|---|
|Case Report||#N/A|[Composition](StructureDefinition-ecr-definitions.html#Composition)||||
|Date of the Report||1198-5256|[Composition.date](StructureDefinition-ecr-definitions.html#Composition.date)||||
...
|Provider||#N/A|[Composition.author](StructureDefinition-ecr-definitions.html#Composition.author)|[PractitionerRole]({{site.data.fhir.uscore}}StructureDefinition-us-core-practitionerrole-definitions.html#PractitionerRole)||US-Core Profile|
...
|Provider Facility/Office Name||3284-26||[PractitionerRole.organization]({{site.data.fhir.uscore}}StructureDefinition-us-core-practitionerrole-definitions.html#PractitionerRole.organization)|[Organization.name]({{site.data.fhir.uscore}}StructureDefinition-us-core-organization-definitions.html#Organization.name)|US-Core Profile|
|Provider Address|streetaddress,  office or suite number (ifapplicable),|3284-27||[PractitionerRole.organization]({{site.data.fhir.uscore}}StructureDefinition-us-core-practitionerrole-definitions.html#PractitionerRole.organization)|[Organization.address]({{site.data.fhir.uscore}}StructureDefinition-us-core-organization-definitions.html#Organization.address)|US-Core Profile|
|Provider Address|city|3284-27||[PractitionerRole.organization]({{site.data.fhir.uscore}}StructureDefinition-us-core-practitionerrole-definitions.html#PractitionerRole.organization)|[Organization.address]({{site.data.fhir.uscore}}StructureDefinition-us-core-organization-definitions.html#Organization.address)|US-Core Profile|
|Provider Address|state|3284-27||[PractitionerRole.organization]({{site.data.fhir.uscore}}StructureDefinition-us-core-practitionerrole-definitions.html#PractitionerRole.organization)|[Organization.address]({{site.data.fhir.uscore}}StructureDefinition-us-core-organization-definitions.html#Organization.address)|US-Core Profile|
|Provider Address|zip|3284-27||[PractitionerRole.organization]({{site.data.fhir.uscore}}StructureDefinition-us-core-practitionerrole-definitions.html#PractitionerRole.organization)|[Organization.address]({{site.data.fhir.uscore}}StructureDefinition-us-core-organization-definitions.html#Organization.address)|US-Core Profile|
|Provider Address|country|3284-27||[PractitionerRole.organization]({{site.data.fhir.uscore}}StructureDefinition-us-core-practitionerrole-definitions.html#PractitionerRole.organization)|[Organization.address]({{site.data.fhir.uscore}}StructureDefinition-us-core-organization-definitions.html#Organization.address)|US-Core Profile|
|Facility||#N/A|[Composition.encounter.location](StructureDefinition-ecr-definitions.html#Composition.encounter.location)|[Location](StructureDefinition-ecr-location-definitions.html#Location)||eCR-Profile|
|Facility ID Number|namespace|3284-13||[Location.identifier](StructureDefinition-ecr-location-definitions.html#Location.identifier)||eCR-Profile|
...
|Pregnant|code|#N/A||[Observation.valueCodeableConcept](StructureDefinition-ecr-pregnancystatus-definitions.html#Observation.valueCodeableConcept)||eCR-Profile|
...
|Diagnoses|display|1198-9058||[Condition.code](StructureDefinition-ecr-condition-definitions.html#Condition.code)||eCR-Profile|
