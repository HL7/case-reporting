...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:PlanDefinition/f:publisher">
      ...
      <sch:assert test="count(f:extension[@url = 'http://fhir.hl7.org/us/case-reporting/StructureDefinition/extension-publisher-code']) &lt;= 1">extension with URL = 'http://fhir.hl7.org/us/case-reporting/StructureDefinition/extension-publisher-code': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.hl7.org/us/case-reporting/StructureDefinition/extension-organization-description']) &lt;= 1">extension with URL = 'http://fhir.hl7.org/us/case-reporting/StructureDefinition/extension-organization-description': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:value) &lt;= 1">value: maximum cardinality of 'value' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>PlanDefinition.publisher.extension</sch:title>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:PlanDefinition/f:contact">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.hl7.org/us/case-reporting/StructureDefinition/extension-contact-address']) &lt;= 1">extension with URL = 'http://fhir.hl7.org/us/case-reporting/StructureDefinition/extension-contact-address': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:PlanDefinition/f:relatedArtifact">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.hl7.org/us/case-reporting/StructureDefinition/extension-rel-artifact-category']) &lt;= 1">extension with URL = 'http://fhir.hl7.org/us/case-reporting/StructureDefinition/extension-rel-artifact-category': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.hl7.org/us/case-reporting/StructureDefinition/extension-rel-artifact-priority']) &lt;= 1">extension with URL = 'http://fhir.hl7.org/us/case-reporting/StructureDefinition/extension-rel-artifact-priority': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:PlanDefinition/f:relatedArtifact/f:extension</sch:title>
  ...
  <sch:pattern>
    <sch:title>PlanDefinition.action.timing[x].repeat 1</sch:title>
